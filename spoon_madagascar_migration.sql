...
-- Safe to re-run: adds the column if this migration was already applied before
-- individual notes existed.
alter table public.spoon_madagascar_reviews
  add column if not exists individual_notes jsonb not null default '{}'::jsonb;
